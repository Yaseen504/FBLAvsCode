...
game_title_img = pygame.image.load('font3_Game_Title.png')

#create button instances
play_button = button.Button(316, 150, play_img, 1.25)
options_button = button.Button(297, 250, options_img, 1)
quit_button = button.Button(336, 360, quit_img, 1)
# video_button = button.Button(226, 75, video_img, 1)
audio_button = button.Button(225, 200, audio_img, 1)
# keys_button = button.Button(246, 325, keys_img, 1)
back_button = button.Button(332, 300, back_img, 1)

game_title = button.Button(225, 40, game_title_img, 0.50)
